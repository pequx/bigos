...
- [Docker Compose](https://docs.docker.com/compose) to run containers locally and during the build.
- [docker-gc](https://github.com/spotify/docker-gc) as docker containers garbage collector.
